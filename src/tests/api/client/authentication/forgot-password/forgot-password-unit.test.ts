...
import { createPasswordResetToken as jwtCreateResetToken } from "../../../../../utils/jwt";
...
const mockedJwtCreateResetToken = jwtCreateResetToken as jest.Mock;
...
describe("forgotPassword handler (unit)", () => {
  ...
  it("returns 200 with token on success", async () => {
    ...
    mockedJwtCreateResetToken.mockReturnValue({
      resetToken: "plain_token_abc",
