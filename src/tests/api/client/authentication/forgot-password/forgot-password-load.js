...
//   BASE_URL=http://localhost:3000 k6 run src/tests/api/client/authentication/forgot-password/forgot-password-load.js
...
export function handleSummary(data) {
  return {
    'src/tests/api/client/authentication/forgot-password/forgot-password-load-summary.json': JSON.stringify(data, null, 2),
