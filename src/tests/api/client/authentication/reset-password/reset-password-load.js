...
//   BASE_URL=http://localhost:3000 k6 run src/tests/api/client/authentication/reset-password/reset-password-load.js
//
...
export default function () {
  ...
  const forgotRes = http.post(
    `${BASE_URL}/api/v1/client/forgot-password`,
  ...
  const res = http.post(
    `${BASE_URL}/api/v1/client/reset-password/${resetToken}`,
...
export function handleSummary(data) {
  return {
    'src/tests/api/client/authentication/reset-password/reset-password-load-summary.json': JSON.stringify(data, null, 2),
