...
//   BASE_URL=http://localhost:3000 k6 run src/tests/api/client/authentication/change-password/change-password-load.js
//
...
export default function () {
  ...
  const res = http.post(
    `${BASE_URL}/api/v1/client/change-password`,
    JSON.stringify(body),
    {
      headers: {
...
export function handleSummary(data) {
  return {
    'src/tests/api/client/authentication/change-password/change-password-load-summary.json': JSON.stringify(data, null, 2),
