...
//
// This example assumes your DB layer exposes a `createClient` and
// `deleteClient` alongside the existing `findClient` — adjust these
...
describe("POST /api/v1/client/login (integration, real DB)", () => {
  beforeAll(async () => {
