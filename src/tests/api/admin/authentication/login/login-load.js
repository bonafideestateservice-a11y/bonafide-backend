...
// NOTE: admin login enforces ADMIN/AGENT role — these accounts must be
// seeded with role AGENT (see src/tests/scripts/seed-load-users.ts).
...
export function handleSummary(data) {
  return {
    'src/tests/api/admin/authentication/login/login-load-summary.json': JSON.stringify(data, null, 2),
